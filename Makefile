...
dep_emq_auth_clientid = git https://github.com/emqtt/emq-auth-clientid v2.3.4
dep_emq_auth_username = git https://github.com/emqtt/emq-auth-username v2.3.4
dep_emq_auth_ldap     = git https://github.com/emqtt/emq-auth-ldap v2.3.4
dep_emq_auth_http     = git https://github.com/emqtt/emq-auth-http v2.3.4
dep_emq_auth_mysql    = git https://github.com/emqtt/emq-auth-mysql v2.3.4
dep_emq_auth_pgsql    = git https://github.com/emqtt/emq-auth-pgsql v2.3.4
dep_emq_auth_redis    = git https://github.com/emqtt/emq-auth-redis v2.3.4
dep_emq_auth_mongo    = git https://github.com/emqtt/emq-auth-mongo v2.3.4
dep_emq_auth_jwt      = git https://github.com/emqtt/emq-auth-jwt v2.3.4
...
# plugin template
dep_emq_plugin_template = git https://github.com/emqtt/emq-plugin-template v2.3.4

# web_hook lua_hook
dep_emq_web_hook  = git https://github.com/emqtt/emq-web-hook v2.3.4
dep_emq_lua_hook  = git https://github.com/emqtt/emq-lua-hook v2.3.4
